...
import { View, Text, TextInput, Pressable, ScrollView, ActivityIndicator, Image, Linking, StyleSheet } from 'react-native';
...
// Brand logo — the SAME mark as the launcher icon (generated by android/generate_icon.ps1 into
// src/assets at @1x/2x/3x). Rendered as an <Image> so the header logo is pixel-identical to the
// app icon the user sees on their home screen.
